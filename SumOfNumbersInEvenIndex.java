...
class SumOfNumbersInEvenIndex					//class definition of SumOfNumbersInEvenIndex class begins
 {
   ...
   public static void main(String args[])		//main method definition begins
	...
	//In this program, a sample of 10 integer values are assigned to an integer array.
        ...
        //The Sum of Numbers in the even index of the integer array is calculated and printed as output.
	...
	int sumOfNumbers=0;
        ...
        System.out.println("\n This program adds numbers in the even index of the integer array & prints it. ");
        System.out.println(" ----------------------------------------------------------------------------- ");
	...
	System.out.println("\n\n The Sum of numbers in the even index of the integer array is :  "+sumOfNumbers);	
 ...
 }    //end of class SumOfNumbersInEvenIndex
