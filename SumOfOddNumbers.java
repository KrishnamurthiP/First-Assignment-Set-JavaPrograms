...
class SumOfOddNumbers					//class definition of SumOfOddNumbers class begins
 {
   ...
   public static void main(String args[])		//main method definition begins
	...
	//In this program, some integer values are accepted from user & assigned to an integer array.
        ...
        //The Sum of Odd Numbers of the integer array is calculated and printed as output.
	...
	short size=0;
        ...
        System.out.println("\n Program Description: This program adds odd numbers of the integer array \n & prints it. ");
	...
	System.out.println("\n\n The Sum of odd numbers of the integer array is :  "+sumOfNumbers);	
